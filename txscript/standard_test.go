...
func TestPayToAddrScript(t *testing.T) {
	...
	p2pkhMain, err := godashutil.NewAddressPubKeyHash(hexToBytes("e34cce70c86"+
	...
	p2shMain, _ := godashutil.NewAddressScriptHashFromHash(hexToBytes("e8c300"+
	...
	p2pkCompressedMain, err := godashutil.NewAddressPubKey(hexToBytes("02192d"+
	...
	p2pkCompressed2Main, err := godashutil.NewAddressPubKey(hexToBytes("03b0b"+
	...
	p2pkUncompressedMain, err := godashutil.NewAddressPubKey(hexToBytes("0411"+
	...
	tests := []struct {
		...
		{(*godashutil.AddressPubKeyHash)(nil), "", errUnsupportedAddress},
		{(*godashutil.AddressScriptHash)(nil), "", errUnsupportedAddress},
		{(*godashutil.AddressPubKey)(nil), "", errUnsupportedAddress},
