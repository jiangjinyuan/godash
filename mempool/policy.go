...
func checkTransactionStandard(tx *godashutil.Tx, height int32,
	medianTimePast time.Time, minRelayTxFee godashutil.Amount,
...
func GetTxVirtualSize(tx *godashutil.Tx) int64 {
	// vSize := (weight(tx) + 3) / 4
