...
//
// NOTE: This is a btcd extension.
func (c *Client) ListAddressTransactionsAsync(addresses []godashutil.Address, account string) FutureListAddressTransactionsResult {
...
//
// NOTE: This is a btcwallet extension.
func (c *Client) ListAddressTransactions(addresses []godashutil.Address, account string) ([]btcjson.ListTransactionsResult, error) {
...
func (r FutureGetCurrentNetResult) Receive() (wire.DASHNet, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
//
// NOTE: This is a btcd extension.
func (c *Client) GetCurrentNet() (wire.DASHNet, error) {
