...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/nargott/godash/peer)
...
```bash
$ go get -u github.com/nargott/godash/peer
```

## Examples

* [New Outbound Peer Example](https://godoc.org/github.com/nargott/godash/peer#example-package--NewOutboundPeer)  
