...
// processed.
func (sm *SyncManager) QueueTx(tx *godashutil.Tx, peer *peerpkg.Peer, done chan struct{}) {
...
// processed.
func (sm *SyncManager) QueueBlock(block *godashutil.Block, peer *peerpkg.Peer, done chan struct{}) {
...
// chain.
func (sm *SyncManager) ProcessBlock(block *godashutil.Block, flags blockchain.BehaviorFlags) (bool, error) {
