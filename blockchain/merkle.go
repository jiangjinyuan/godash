...
// is the zeroHash.
func BuildMerkleTreeStore(transactions []*godashutil.Tx, witness bool) []*chainhash.Hash {
...
func ExtractWitnessCommitment(tx *godashutil.Tx) ([]byte, bool) {
...
func ValidateWitnessCommitment(blk *godashutil.Block) error {
