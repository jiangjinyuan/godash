...
//
// This function is safe for concurrent access.
func (b *BlockChain) CalcSequenceLock(tx *godashutil.Tx, utxoView *UtxoViewpoint, mempool bool) (*SequenceLock, error) {
	b.chainLock.Lock()
...
func (b *BlockChain) calcSequenceLock(node *blockNode, tx *godashutil.Tx, utxoView *UtxoViewpoint, mempool bool) (*SequenceLock, error) {
...
func (b *BlockChain) reorganizeChain(detachNodes, attachNodes *list.List) error {
	...
	attachBlocks := make([]*godashutil.Block, 0, attachNodes.Len())
...
//
// This function MUST be called with the chain state lock held (for writes).
func (b *BlockChain) connectBestChain(node *blockNode, block *godashutil.Block, flags BehaviorFlags) (bool, error) {
