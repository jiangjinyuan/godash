...
func (b *BlockChain) initChainState() error {
	...
	err := b.db.View(func(dbTx database.Tx) error {
		...
		blockWeight := uint64(GetBlockWeight(godashutil.NewBlock(&block)))
...
// raw block for the provided node, deserialize it, and return a godashutil.Block
// with the height set.
func dbFetchBlockByNode(dbTx database.Tx, node *blockNode) (*godashutil.Block, error) {
...
//
// This function is safe for concurrent access.
func (b *BlockChain) BlockByHash(hash *chainhash.Hash) (*godashutil.Block, error) {
