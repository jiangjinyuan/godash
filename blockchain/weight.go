...
func GetBlockWeight(blk *godashutil.Block) int64 {
...
func GetTransactionWeight(tx *godashutil.Tx) int64 {
	msgTx := tx.MsgTx()
...
func GetSigOpCost(tx *godashutil.Tx, isCoinBaseTx bool, utxoView *UtxoViewpoint,
