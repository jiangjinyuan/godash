...
func WriteMessageN(w io.Writer, msg Message, pver uint32, btcnet DASHNet) (int, error) {
...
func WriteMessage(w io.Writer, msg Message, pver uint32, btcnet DASHNet) error {
...
func WriteMessageWithEncodingN(w io.Writer, msg Message, pver uint32,
	btcnet DASHNet, encoding MessageEncoding) (int, error) {
...
func ReadMessageWithEncodingN(r io.Reader, pver uint32, btcnet DASHNet,
...
func ReadMessageN(r io.Reader, pver uint32, btcnet DASHNet) (int, Message, []byte, error) {
...
func ReadMessage(r io.Reader, pver uint32, btcnet DASHNet) (Message, []byte, error) {
