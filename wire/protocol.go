...
const (
	// MainNet represents the main DASH network.
	MainNet DASHNet = 0xd9b4bef9

	// TestNet represents the regression test network.
	TestNet DASHNet = 0xdab5bffa
...
// pretty printing.
var bnStrings = map[DASHNet]string{
	MainNet:  "MainNet",
	TestNet:  "TestNet",
	TestNet3: "TestNet3",
}
